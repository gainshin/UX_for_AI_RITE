...
`,
  ...
  {
    id: "unit-2",
    title: "選擇正確的戰場：定義 AI Use Case 的五個原則",
    summary:
      "運用五項原則與數位雙胞胎思維，挑選讓 AI 發揮顧問價值的應用場景，兼顧可行性與用戶信任。",
    scenario: "medical",
    minutes: 30,
    passThreshold: 72,
    introduction: [
      "選擇 AI Use Case 的關鍵在於讓 AI 從「老闆」轉為「顧問」，提供專家難以即時掌握的資訊，仍由人類做最後決策。",
      "五項設計原則確保使用者擁有自主權、理解 AI 的推理並獲得成就感，建立長期信任循環。",
      "透過數位雙胞胎 (Digital Twin) 將輸入、計算與輸出映射到用戶旅程，可逐步擴張 AI 價值並控管風險。",
    ],
    concepts: [
      {
        heading: "AI Use Case 五原則",
        example:
          "在醫療決策支援中，AI 提供最新文獻與病患歷史做為建議，醫師保有否決權與透明解釋。",
        points: [
          {
            title: "彈性的核心能力 (Flexible Core Capability)",
            detail: "保留人工覆核、編輯或否決機制，避免 AI 獨斷決策造成風險。",
          },
          {
            title: "讓使用者參與 (User Participation)",
            detail: "設計回饋渠道、社群貢獻或個人化設定，讓使用者感受自己對結果的影響力。",
          },
          {
            title: "完整的業務邏輯 (Business Logic)",
            detail: "為 AI 建立護欄與政策，避免只追逐單一指標而忽略合規與品牌信任。",
          },
          {
            title: "可解釋性 (Explainability)",
            detail: "揭露推理步驟、資料來源與信心水準，讓專家理解建議的脈絡。",
          },
          {
            title: "成就感 (Sense of Achievement)",
            detail: "透過進度指標、徽章或成果摘要，讓使用者看見自身掌控力的提升。",
          },
        ],
      },
      {
        heading: "數位雙胞胎的循序搭建",
        example:
          "智慧手錶團隊先用脈搏與時間建立健康基線，再逐步納入 GPS 與飲食資料，形成個人化顧問。",
        points: [
          {
            title: "階段一：基礎感知",
            detail: "聚焦最小可行輸入與輸出，快速驗證 AI 是否帶來新的洞見。",
          },
          {
            title: "階段二：用戶參與與情境",
            detail: "加入個人身體數據與環境訊號，偵測異常並提供情境化建議。",
          },
          {
            title: "階段三：整合數據孤島",
            detail: "串接飲食、社交與消費資料，打造全方位的個人化服務。",
          },
        ],
      },
    ],
    practice: [
      {
        title: "AI 顧問畫布",
        description: "套用五原則盤點團隊目前的 AI Use Case，釐清人機分工與護欄。",
        steps: [
          "描繪目標場景中的使用者、主要決策與期望成果。",
          "逐一檢視五項原則是否被滿足，列出需要補強的設計。",
          "定義 AI 建議的覆核流程與量測成就感的指標。",
        ],
      },
      {
        title: "數位雙胞胎藍圖",
        description: "以輸入-計算-輸出三層架構，描繪產品的數位雙胞胎演進階段。",
        steps: [
          "列出最小可行的輸入資料、計算邏輯與輸出結果。",
          "規劃階段二需新增的個人化或情境資料，說明使用者參與方式。",
          "盤點未來可整合的私有/外部資料來源與對應的護欄。",
        ],
      },
    ],
    quiz: [
      {
        ...
        type: "multiple",
        scenario: "medical",
        prompt: "在臨床決策支援系統中，若要讓 AI 從「老闆」變成「顧問」，團隊應優先做什麼？",
        options: [
          { id: "a", text: "確保 AI 提供證據來源並由醫師做最終判斷" },
          { id: "b", text: "讓 AI 自動下達所有醫囑與用藥" },
          { id: "c", text: "阻擋醫師對建議進行修改" },
          { id: "d", text: "只顯示最終結論，不顯示推理過程" },
        ],
        correctOptionIds: ["a"],
        explanation: "AI 應輔助臨床決策並保留人工否決權，才能建立信任。",
      },
      {
        id: "u2-q2",
        type: "multiple",
        scenario: "ecommerce",
        prompt: "在電商 AI 助理設計中，為了落實 AI Use Case 五原則，以下哪些作法值得採行？ (可複選)",
        options: [
          { id: "a", text: "提供使用者置頂或關閉推薦的覆寫按鈕" },
          { id: "b", text: "隱藏所有 AI 標示，避免使用者察覺" },
          { id: "c", text: "蒐集社群回饋並回饋給模型調整" },
          { id: "d", text: "僅以點擊率作為唯一成功指標" },
        ],
        correctOptionIds: ["a", "c"],
        explanation: "覆寫權與使用者參與能提升掌控感；隱藏或單一指標會削弱信任。",
      },
      {
        id: "u2-q3",
        type: "matching",
        scenario: "education",
        prompt: "將 AI Use Case 五原則與對應的教育應用設計配對。",
        pairs: [
          {
            id: "p1",
            prompt: "彈性的核心能力",
            match: "讓教師或學生隨時介入修正 AI 建議",
          },
          {
            id: "p2",
            prompt: "可解釋性",
            match: "提供推理步驟或推薦原因讓人理解",
          },
          {
            id: "p3",
            prompt: "成就感",
            match: "設計進度或徽章顯示學習者的成長",
          },
        ],
        explanation: "五項原則透過具體互動轉化為可感知的學習體驗。",
      },
      {
        id: "u2-q4",
        type: "multiple",
        scenario: "ai-hiring",
        prompt: "在人力資源 AI 招募流程中，建立護欄 (Guardrails) 的主要目的為何？ (可複選)",
        options: [
          { id: "a", text: "防止模型為了提高通過率而犧牲公平與合規" },
          { id: "b", text: "完全停用人類審核" },
          { id: "c", text: "將所有決策交給單一指標" },
          { id: "d", text: "把業務規則與 fail-safe 寫入工作流程" },
        ],
        correctOptionIds: ["a", "d"],
        explanation: "護欄用來保護公平性並保留人工介入，而非排除人類或簡化成單一指標。",
      },
      {
        id: "u2-q5",
        type: "multiple",
        scenario: "social",
        prompt: "社交平台啟用 AI 社群管理助理時，哪些做法能強化使用者參與與信任？ (可複選)",
        options: [
          { id: "a", text: "即時呈現社群檢舉與調整後的結果" },
          { id: "b", text: "移除所有自訂偏好設定" },
          { id: "c", text: "提供自訂詞庫或警示敏感度選項" },
          { id: "d", text: "拒絕說明 AI 為何判定某則貼文" },
        ],
        correctOptionIds: ["a", "c"],
        explanation: "透明與可調整性提升參與感；封閉或不解釋會降低信任。",
      },
      {
        id: "u2-q6",
        type: "matching",
        scenario: "medical",
        prompt: "將智慧手錶數位雙胞胎的三個階段與輸入/輸出特性配對。",
        pairs: [
          {
            id: "p1",
            prompt: "階段一：基礎功能",
            match: "使用脈搏與時間建立基本健康水平",
          },
          {
            id: "p2",
            prompt: "階段二：用戶參與",
            match: "加入 GPS 海拔與個人身體數據進行分析",
          },
          {
            id: "p3",
            prompt: "階段三：整合數據孤島",
            match: "串接飲食與社交資料提供整體健康顧問",
          },
        ],
        explanation: "數位雙胞胎需循序引入更多資料，才能安全擴張價值。",
      },
      {
        id: "u2-q7",
        type: "multiple",
        scenario: "ecommerce",
        prompt: "以下哪些屬於在定義 AI Use Case 時的常見錯誤模式？ (可複選)",
        options: [
          { id: "a", text: "拿到產品規格書就直接設計 UI，而未界定 AI 價值" },
          { id: "b", text: "先釐清輸入、計算與輸出再規劃介面" },
          { id: "c", text: "先堆砌各種 AI 功能，最後才思考使用者旅程" },
          { id: "d", text: "與使用者共創流程並逐步擴充" },
        ],
        correctOptionIds: ["a", "c"],
        explanation: "規格書導向與功能堆砌都會弱化 AI 角色與價值。",
      },
      {
        id: "u2-q8",
        type: "multiple",
        scenario: "medical",
        prompt: "智慧手錶專案從階段一進入階段二時，應新增哪些元素？ (可複選)",
        options: [
          { id: "a", text: "GPS 海拔與環境變數" },
          { id: "b", text: "個人身體數據如年齡與 BMI" },
          { id: "c", text: "移除對異常偵測的需求" },
          { id: "d", text: "限制使用者提供任何補充資料" },
        ],
        correctOptionIds: ["a", "b"],
        explanation: "階段二強調個人化與情境資料，而非縮減資料或功能。",
      },
      {
        id: "u2-q9",
        type: "matching",
        scenario: "education",
        prompt: "將不同應用場景與落實五原則的重點動作配對。",
        pairs: [
          {
            id: "p1",
            prompt: "醫療臨床決策",
            match: "揭露推理鏈並標示信心水準給專家參考",
          },
          {
            id: "p2",
            prompt: "電商客服助理",
            match: "提供使用者自訂護欄與可調整的推薦邏輯",
          },
          {
            id: "p3",
            prompt: "教育學習教練",
            match: "回報學習進度與成就，強化使用者掌控感",
          },
        ],
        explanation: "不同場景都可透過五原則找到合適的信任機制。",
      },
      {
        id: "u2-q10",
        type: "multiple",
        scenario: "ai-hiring",
        prompt: "評估 AI Use Case 導入成效時，哪些指標能反映成就感與可解釋性？ (可複選)",
        options: [
          { id: "a", text: "專家採納 AI 建議後的決策時間縮短" },
          { id: "b", text: "使用者自評對 AI 控制力的提升" },
          { id: "c", text: "僅追蹤模型的 AUC 分數" },
          { id: "d", text: "關閉所有與人互動的教學資源" },
        ],
        correctOptionIds: ["a", "b"],
        explanation: "衡量掌控感與決策效率能補足指標，單看模型分數難以判斷成效。",
      },
    ],
    code: {
      title: "AI Use Case Canvas 範例",
      description: "以輸入-計算-輸出與護欄設定，快速草擬一個具可解釋性的 AI Use Case。",
      content: `const guardrails = {
  allowOverride: true,
  forbiddenActions: ["auto_confirm_contract"],
  requireExplanation: true,
};

export function draftUseCase({ inputs, computation, outputs }) {
  return {
    inputs,
    computation,
    outputs,
...
// TODO: 以實際場景替換 inputs/computation/outputs，並新增成就感量測指標。`,
      nextSteps: [
        "與利害關係人確認護欄與人工覆核流程是否完整。",
        "為每個階段補上資料品質檢查與說明模板。",
        "加入成就感與參與度指標，定期檢視信任成長曲線。",
      ],
    },
  },
  {
